...
function MatchAnalytics({ match, loading, details, saved, close, toggleSaved }) {
  ...
  return (
    <div className={`min-h-screen ${lightMode ? "theme-light" : "theme-dark"} relative`}>
      ...
      {selectedTrend?.sourceUrl && <a href={selectedTrend.sourceUrl} target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 z-[90] inline-flex items-center gap-2 rounded-xl border border-[#58b8ff]/60 bg-[#142650] px-4 py-3 text-xs font-bold text-[#d5e4ff] shadow-[0_0_28px_rgba(50,130,255,.28)] hover:bg-[#1d3c78] transition">🔗 Open original source</a>}
