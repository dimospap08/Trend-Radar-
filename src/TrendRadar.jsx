    ...
    <div className={`min-h-screen ${lightMode ? "theme-light" : "bg-[#060512] text-[#f2eefa]"} relative`}>
      ...
      <style>{`
        ...
        * { scrollbar-color: #2a2150 #060512; }
        ...
        .theme-light { background: #f7f8fc; color: #171329; }
        .theme-light .glass { background: #ffffff; border-color: #e6e2f4; box-shadow: 0 8px 24px rgba(47,35,92,.07); }
        .theme-light .body-f, .theme-light .mono { color: #5e5874; }
        .theme-light header { background: rgba(247,248,252,.9); border-color: #e6e2f4; }
